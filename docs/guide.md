...
- [1. 初始化：一处收拢所有 skill](#1-初始化一处收拢所有-skill)
- [2. Web 控制台：全景开关矩阵 (Matrix)](#2-web-控制台全景开关矩阵-matrix)
  - [矩阵交互核心特性](#矩阵交互核心特性)
  - [skill 详情与就地启停 (DetailModal)](#skill-详情与就地启停)
  - [实时同步与安全模型](#实时同步与安全模型)
- [3. Web 控制台：三方一致性体检 (Doctor)](#3-web-控制台三方一致性体检-doctor)
- [4. Web 控制台：既有技能收编 (Adopt)](#4-web-控制台既有技能收编-adopt)
- [5. Web 控制台：技能安装与安全审计 (Add)](#5-web-控制台技能安装与安全审计-add)
- [6. Web 控制台：技能市场与 Prompt 深度预览 (Market)](#6-web-控制台技能市场与-prompt-深度预览-market)
- [7. Web 控制台：技能维护与文件级 Diff (Update)](#7-web-控制台技能维护与文件级-diff-update)
- [8. 终端交互矩阵 (TUI)](#8-tui终端里的开关矩阵)
- [9. MCP Bridge：让 Agent 直接消费中央仓库](#9-mcp-bridge让-agent-直接读中央仓库)
- [10. 团队协作：项目清单一键对齐 (Team)](#10-团队协作项目清单一键对齐)
- [11. 策略治理与私有 Registry (Policy)](#11-策略治理与私有-registrygui策略页)
- [12. 现代滚动架构与无多重滚动条设计规范](#12-现代滚动架构与无多重滚动条设计规范)
- [13. 生态扩圈与 CI/CD 自动化门禁](#13-生态扩圈与-cicd-自动化门禁)
- [14. 命令行速查表](#14-命令速查)
- [15. 支持的目标 Agent 与渠道矩阵](#15-支持的目标)
...
## 6. Web 控制台：技能市场与 Prompt 深度预览 (Market)
...
## 7. Web 控制台：技能维护与文件级 Diff (Update)
...
## 11. Web 控制台：策略治理与私有 Registry (Policy)
