...
- 2026-09-11 CI/无头环境鲁棒性（v0.19.1 Agent 检测缓存与物理扫描修复）：详见 [CHANGELOG.md](../../CHANGELOG.md#0191---2026-09-11)
- 2026-09-11 适配性顾问与现代交互（v0.20.0 Token 启发式估算、依赖静态探测、渠道规则引擎与 GUI 全矩阵视觉排版）：详见 [CHANGELOG.md](../../CHANGELOG.md#0200---2026-09-11)
- 2026-09-11 滚动架构重构（v0.20.1 矩阵卡片内部吸附底栏、图例收敛与展开控制）：详见 [CHANGELOG.md](../../CHANGELOG.md#0201---2026-09-11)
- 2026-09-11 视口无重叠体验（v0.20.2 视口根级锁定、双滚动模式分离与彻底消除嵌套多重滚动条）：详见 [CHANGELOG.md](../../CHANGELOG.md#0202---2026-09-11)
- 2026-09-11 GUI 深度自测优化（v0.20.3 智能防溢出 Tooltip、行级全开全停、弹窗就地启停、市场定向安装、单技能更新 diff 与环境热探测）：详见 [CHANGELOG.md](../../CHANGELOG.md#0203---2026-09-11) 与 [docs/guide.md](../guide.md)
